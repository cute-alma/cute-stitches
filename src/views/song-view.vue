<template>
  <div class="flex flex-col w-full">
    ...
    <div class="flex flex-row justify-between items-center w-full">
      ...
      />
      <div
        class="flex flex-row-reverse w-full sm:flex-row gap-[10px] px-[5px] justify-end items-center"
      >
        <h3 class="text-3xl">Cuetify</h3>
        <img
          src="/img/logo_cute_stitchesbyalma.jpeg"
          class="invisible sm:visible w-[100px] h-[100px]"
          alt="logo cute stitches by alma"
        />
      </div>
    </div>
    ...
    <div class="flex flex-row w-full h-full gap-[10px]">
      <div
        class="hidden md:flex md:flex-col md:items-end w-full max-w-[350px] max-h-screen overflow-y-auto"
      >
        <p v-if="songDetails.type == 'ondemand'">
          tus favoritos a <span class="font-rouge-script text-3xl">Pedido</span>
        </p>
